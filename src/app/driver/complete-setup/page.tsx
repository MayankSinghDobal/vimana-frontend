// src/app/driver/complete-setup/page.tsx
'use client';
...
export default function DriverCompleteSetup() {
  ...
  useEffect(() => {
    const setupDriverRole = async () => {
      ...
      try {
        console.log('Setting up driver role for user:', userId);
        ...
        console.log('Role switched to driver:', response.data);
        ...
        console.error('Error setting up driver role:', err);
        setError(err.response?.data?.error || 'Failed to setup driver account. Please try again.');
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-vimana-indigo to-vimana-crimson text-white p-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-devanagari text-vimana-gold mb-4">Setting up your Driver Account</h2>
          <p className="text-vimana-silver">Please wait while we prepare your celestial chariot...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-b from-vimana-indigo to-vimana-crimson text-white p-8 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => router.push('/rider/complete-setup')}
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-vimana-indigo to-vimana-crimson text-white p-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-devanagari text-vimana-gold mb-4">Welcome, Divine Charioteer!</h2>
          <p className="text-vimana-silver mb-4">Your driver account has been set up successfully.</p>
